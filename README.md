...
Je suis actuellement en **Master 1** d'informatique (Diplôme en 2027) et je me spécialise dans le développement full-stack. Mon objectif est de créer des expériences utilisateur exceptionnelles en utilisant les dernières technologies.

**Stack actuel:** React 18 • Vite • Tailwind CSS • Framer Motion • React Router
...
**Frontend:** React • Vue.js • Vite • Tailwind CSS • Framer Motion • React Router • Radix UI • CSS / HTML
