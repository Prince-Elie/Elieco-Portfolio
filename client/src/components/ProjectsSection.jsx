      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative">
                ...
                <div className="relative bg-background border border-border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 h-full flex flex-col">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3">
                      <div className={`px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm ${
                        ...
                        {project.status === "Live" ? t.projects.live : t.projects.development}
                      </div>
                    </div>
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex gap-3 pt-4 border-t border-border">
                      ...
                      >
                        <Eye size={16} />
                        {project.demoUrl === "#" ? t.projects.comingSoon : t.projects.live}
                      </motion.a>
        ...
        >
          <div className="bg-background border border-border rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-4">{t.projects.likeWhatYouSee}</h3>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              {t.projects.alwaysOpen}
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href="https://github.com/Prince-Elie"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
